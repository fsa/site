...
Обратите внимание. Чтобы все механизмы автоматического формирования IPv6 адресов на конечных узлах работали, ваша сеть должна использовать префикс длиной 64 бита! Если в вашей сети используется сеть с маской от 65 до 128 бит, то все механизмы автоматического формаирования IPv6 адреса перестают работать!!!
