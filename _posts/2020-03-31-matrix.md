...
6. [Сайт для тестирования федерации с сервером matrix.org][federationtester]
7. [Спецификация Server-Server API][matrix-s2s]
