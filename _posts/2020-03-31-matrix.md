...
Современные версии Synapse в первую очередь проверяют /.well-known/matrix/server и только при её отсутствии обращаются к записям в DNS. SRV записи использовались старыми версиями Synapse до версии 0.99, однако в современных условиях вряд ли вы сможете их встретить. Поэтому SRV записи в DNS сейчас избыточны.
...
Более актуальные версии скрипта можно найти [в репозитории на Github][element-web-update].
