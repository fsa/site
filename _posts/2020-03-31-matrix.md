...
Как указано в [документации matrix-synapse][matrix-synapse-cert] записи в DNS используются только для старых версий сервера (0,34 или более старых). Использование их большого смысла не имеет, т.к. в любом случае, вы столкнётесь с необходимостью настройки вашего веб-сервера.
...
3. [Конфигурирование сертификатов при использовании Synapse 1.0 (англ.)][matrix-synapse-cert]
...
[matrix-synapse-cert]: https://github.com/matrix-org/synapse/blob/master/docs/MSC1711_certificates_FAQ.md#configuring-certificates-for-compatibility-with-synapse-100
