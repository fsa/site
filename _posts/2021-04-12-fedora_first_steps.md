...
Если вы знаете имя команды, но в вашей системе её нет, то можно поискать:
...
В том числе это нужно, чтобы иметь возможность подключиться к базам данных: MySQL, PostgreSQL, Redis и другим. Обратите внимание на флаг `-P`. Он позволит сохранить значение политики после перезагрузки машины.
