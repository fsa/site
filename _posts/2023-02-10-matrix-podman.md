...
О том как настроить обнаружение вашего сервера на домене я писывал в своей предыдущей [заметке про matrix](https://tavda.net/matrix). Обратите внимание на одноимённый раздел.
