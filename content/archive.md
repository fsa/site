---
title: Архив
description: Здесь собраны мои старые работы, которые сейчас не представляют большой ценности
---
## Контроллер умного дома SHCC

[SHCC](/shcc/)

Это был проект по созданию своего контроллера умного дома. Я начал переделывать проект на Symfony и потребовалось полностью перерабатывать проект. Увы, как таковой умный дом у меня не расширялся и я потерял интерес.
...
[Статья по установке FreeBSD в качестве рабочей станции (Исходный код оригинала)](/FreeBSD/desktop.xml)
