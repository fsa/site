...
tags: [IPv6]
description: Небольшая заметка по поводу перехода на IPv6. Хотя она и писалась с целью поднять карму на Хабре, содержит описание моего личного опыта работы с IPv6 сетями, который может быть полезен начинающим.
---
