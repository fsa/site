...
![Рисунок 1 — CLAT активен при сетевом подключении только по протоколу IPv6.](/img/ipv6/Fig1-CLAT-active-on-a-IPv6-only-network-connection.webp)
...
![Включение анонса PREF64 в RA](/img/ipv6/lan_ra_pref64.png)

Включить опцию 108 DHCPv4 тоже легко. Это делается примерно там же, но на другой вкладке.

![Включение DHCPv4 опции «IPv6-only Preferred»](/img/ipv6/lan_dhcp_option_108.png)
