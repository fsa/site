...
![Настройка сети узла ALPHA](/img/ipv6/ipv6_ll.png)

![Настройка сети узла BETA](/img/ipv6/ipv6_ll2.png)

Даже если отключить IPv4 протокол, узлы прекрасно продолжают видеть друг друга.

![Доступность общих папок при отключении IPv4](/img/ipv6/ipv6_share.png)
