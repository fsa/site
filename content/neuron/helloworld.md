...
layout: neuron
title: Hello, World!
description: PHP фреймворк Neuron, первые шаги
---
...
Все классы фреймворка расположены в пространстве имён `FSA\Neuron`. Для начала использования фреймворка создайте [класс App]({{< relref "app" >}}). Например:
