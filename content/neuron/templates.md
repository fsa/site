...
layout: neuron
title: Шаблоны
description: PHP фреймворк Neuron - файлы шаблонов
---
...
Кроме этого, могут быть определены и другие методы, которые можно вызывать с использованием [объекта response]({{< relref "response" >}}).
