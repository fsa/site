...
slug: "first-steps-sql"
date: 2023-02-07 23:48:00 +0700
tags: [MySQL, PostgreSQL]
description: Небольшая заметка для тех, кто только начинает программировать и у него возникает необходимость создать свои первые запросы к SQL серверу. Рассматриваются запросы, которые могут использоваться практически во всех современных серверах баз данных использующих язык SQL.
---
