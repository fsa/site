...
description: Перевод статьи с ресурса Jool - сайт с документацией модуля ядра linux, который занимается SIIT и NAT64.
---
Это авторский перевод [статьи с сайта разработчиков Jool](https://www.jool.mx/en/intro-xlat.html) - модуля ядра linux, который занимается SIIT и NAT64. Один из примеров использования этого модуля можно найти [в другой моей заметке про NAT64 и DNS64](/dns64).
